...
This is the source code of 'Line Drawing Guided Progressive Inpainting of Mural Damages'. We provide the codes, the partitioning of the datasets, and the pretrained models on DhMural1714 dataset. For convienence of introduction, the proposed network is named as MuralNet.
